...
VALUES
	...
	('Yearwood', 'Max', 'yahoo.com'),
	('Stokes', 'Kimberly', 'cnn.com'),
	('Cooper', 'Bradford', 'techonthenet.com'),
	('Chang', 'Claire', 'huffingtonpost.com'),
	('Johnson', 'Howard', 'instagram.com'),
	('Ramirez', 'Javier', 'facebook.com'),
	('Camacho', 'Juan', 'wikipedia.com'),
	('McConnell', 'Sophie', 'google.com');
...
VALUES
	...
	((select customerId from customers where contactLastName = '' and contactFirstName = ''), '2024/02/10'),
	((select customerId from customers where contactLastName = '' and contactFirstName = ''), '2024/02/10'),
	((select customerId from customers where contactLastName = '' and contactFirstName = ''), '2024/02/10'),
	((select customerId from customers where contactLastName = '' and contactFirstName = ''), '2024/02/10'),
	((select customerId from customers where contactLastName = '' and contactFirstName = ''), '2024/02/01');
